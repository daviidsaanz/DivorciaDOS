...
namespace EZCameraShake
{
    ...
    public class CameraShaker : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            // Guardamos la posición y rotación original de la cámara
        ...
        void Update()
        {
            ...
            // Sumamos todos los shakes activos
            ...
            // Aplica el shake respecto a la posición y rotación originales de la cámara
            transform.localPosition = originalPosition + posAddShake + RestPositionOffset;
            transform.localRotation = originalRotation * Quaternion.Euler(rotAddShake + RestRotationOffset);
        }
